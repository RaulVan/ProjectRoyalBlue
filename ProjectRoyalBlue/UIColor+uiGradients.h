...
//typedef NS_ENUM(NSUInteger; UIGGradients) {
//    UIGEmeraldWater;
//    UIGLemonTwist,
//    UIGHorizon,
//    UIGRoseWater,
...
//    UIGCheerUpEmoKid,
//    UIGShore,
//    UIGFacebookMessenger,
//    UIGSoundCloud,
//    UIGBehongo,
//
//};

@interface UIColor (uiGradients)
...
@interface UIGGradient : NSObject

//@property (nullable, copy) NSArray *UIGEmeraldWater;
